...
export default function HomePage() {
  return (
    <main className="dark bg-background text-foreground antialiased">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            {/* CTA Buttons */}
            <div className="flex items-center gap-3">
              <button className="hidden sm:block px-4 py-2 text-muted-foreground hover:text-foreground font-medium transition-colors">
                Sign In
              </button>
              <button className="px-6 py-2.5 bg-gradient-brand text-white font-semibold rounded-lg hover:shadow-glow-brand transition-all hover:scale-105">
                Get Started Free
              </button>
            </div>
          </div>
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden bg-gradient-hero">
        {/* Background Pattern */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">You&apos;re not alone. Here&apos;s what everyone struggles with.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-red-500/5 border-2 border-red-500/20 rounded-xl p-8">
              ...
              <p className="text-muted-foreground">
                You have ambitious goals but they stay in your head or a random note. They never become concrete time blocks, so they never get done.
              </p>
            </div>
            ...
            <div className="bg-red-500/5 border-2 border-red-500/20 rounded-xl p-8">
              ...
              <p className="text-muted-foreground">
                You spend 2+ hours every Sunday playing calendar Tetris, trying to fit everything in. By the time you&apos;re done, you&apos;re exhausted.
              </p>
            </div>
            ...
            <div className="bg-red-500/5 border-2 border-red-500/20 rounded-xl p-8">
              ...
              <p className="text-muted-foreground">
                Your week is driven by what&apos;s urgent, not what&apos;s important. Important things get pushed week after week.
              </p>
            </div>
            ...
            <div className="bg-red-500/5 border-2 border-red-500/20 rounded-xl p-8">
              ...
              <p className="text-muted-foreground">
                Your calendar is a mess of random tasks scattered throughout the day. You never get into deep work mode.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-subtle">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Your personal AI planning assistant that builds your week for you</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Step 1 */}
            <div className="bg-card rounded-xl p-8 shadow-lg border border-border hover:border-primary/50 transition-all text-center">
              ...
              <p className="text-muted-foreground">
                Tell MicroPlanner what you want to achieve: &quot;Gym 3x/week&quot;, &quot;Side project 10h&quot;, &quot;Learn Spanish 30min/day&quot;
              </p>
            </div>
            ...
            <div className="bg-card rounded-xl p-8 shadow-lg border border-border hover:border-primary/50 transition-all text-center">
              ...
              <p className="text-muted-foreground">
                AI analyzes your calendar, energy patterns, and preferences to build the perfect weekly schedule in 30 seconds.
              </p>
            </div>
            ...
            <div className="bg-card rounded-xl p-8 shadow-lg border border-border hover:border-primary/50 transition-all text-center">
              ...
              <p className="text-muted-foreground">
                One-click sync to Google Calendar. Follow your plan and achieve 40% more than you would manually planning.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              MicroPlanner doesn&apos;t just fill your calendar. It understands you and builds schedules that actually work.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="bg-card/70 backdrop-blur border border-border rounded-xl p-6 hover:border-primary/50 transition-all">
              ...
              <p className="text-muted-foreground">Tracks what works and what doesn&apos;t. Gets smarter with every week.</p>
            </div>
            ...
            <div className="bg-card/70 backdrop-blur border border-border rounded-xl p-6 hover:border-primary/50 transition-all">
              ...
              <p className="text-muted-foreground">Morning person? Night owl? Schedules hard tasks when you&apos;re most productive.</p>
            </div>
            ...
            <div className="bg-card/70 backdrop-blur border border-border rounded-xl p-6 hover:border-primary/50 transition-all">
              ...
              <p className="text-muted-foreground">Syncs perfectly with Google Calendar. No more manual copying.</p>
            </div>
            ...
            <div className="bg-card/70 backdrop-blur border border-border rounded-xl p-6 hover:border-primary/50 transition-all">
              ...
              <p className="text-muted-foreground">Beautiful week view that makes it easy to see and adjust your schedule.</p>
            </div>
            ...
            <div className="bg-card/70 backdrop-blur border border-border rounded-xl p-6 hover:border-primary/50 transition-all">
              ...
              <p className="text-muted-foreground">Track progress, completion rates, and get personalized recommendations.</p>
            </div>
            ...
            <div className="bg-card/70 backdrop-blur border border-border rounded-xl p-6 hover:border-primary/50 transition-all">
              ...
              <p className="text-muted-foreground">Your data never used to train public models. GDPR compliant.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Here&apos;s what our beta users are saying</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-card/70 rounded-xl p-6 border border-border">
              ...
              <p className="text-muted-foreground mb-4 italic">
                &quot;I went from 2 hours of planning every Sunday to 2 minutes. This is a game-changer for my productivity.&quot;
              </p>
              <div className="flex items-center gap-3">
            ...
            <div className="bg-card/70 rounded-xl p-6 border border-border">
              ...
              <p className="text-muted-foreground mb-4 italic">
                &quot;Finally achieved my goal of working out 4x/week. The AI knows when I have energy and schedules accordingly.&quot;
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center text-primary font-bold">
                  SK
            ...
            <div className="bg-card/70 rounded-xl p-6 border border-border">
              ...
              <p className="text-muted-foreground mb-4 italic">
                &quot;As a freelancer juggling multiple projects, MicroPlanner keeps me organized and prevents burnout. Worth every penny.&quot;
              </p>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center text-primary font-bold">
                  MR
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-subtle">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-gradient-brand rounded-2xl shadow-2xl p-8 text-white relative transform lg:scale-105">
              <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                <span className="bg-green-500 px-4 py-1 rounded-full text-white text-sm font-semibold shadow-lg">
                  ⭐ MOST POPULAR
                </span>
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Everything you need to know about MicroPlanner</p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-brand text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to stop planning and start doing?</h2>
